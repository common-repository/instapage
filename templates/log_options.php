...
<table>
  ...
  <tbody>
    ...
    <?php foreach ($rows as $key => $value): ?>
        <tr>
            <td><?php echo InstapageCmsPluginConnector::escapeHTML($index) ?></td>
            <td><?php echo InstapageCmsPluginConnector::escapeHTML($key) ?></td>
            <td><?php echo InstapageCmsPluginConnector::escapeHTML($value) ?></td>
        </tr>
        <?php $index++; ?>
    <?php endforeach; ?>
  </tbody>
